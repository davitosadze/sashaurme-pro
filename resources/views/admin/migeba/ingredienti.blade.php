...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">ინგრედიენტის მიღება</h4> </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <form action='insertIngredienti' method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select required name="product_id" class="form-control" id="">
                            ...
                            <option value="{{$ingredienti->id}}">{{$ingredienti->product_name}}</option>
